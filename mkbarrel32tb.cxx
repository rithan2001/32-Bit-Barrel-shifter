...
/* String declarations */
static std::string const __str_literal_4("\n Arithmetic barrel left  shifter= %d ", 38u);
static std::string const __str_literal_2("\n Arithmetic barrel right shifter= %d ", 38u);
static std::string const __str_literal_3("logical barrel left shifter= %d ", 32u);
static std::string const __str_literal_1("logical barrel right shifter= %d ", 33u);


/* Constructor */
MOD_mkbarrel32tb::MOD_mkbarrel32tb(tSimStateHdl simHdl, char const *name, Module *parent)
...
void MOD_mkbarrel32tb::init_symbols_0()
{
...
void MOD_mkbarrel32tb::RL_go()
{
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_display(sim_hdl, this, "s,32", &__str_literal_1, 5u);
    dollar_display(sim_hdl, this, "s,32", &__str_literal_2, 5u);
    dollar_display(sim_hdl, this, "s,32", &__str_literal_3, 92u);
    dollar_display(sim_hdl, this, "s,32", &__str_literal_4, 95u);
...
void MOD_mkbarrel32tb::reset_RST_N(tUInt8 ARG_rst_in)
{
...
void MOD_mkbarrel32tb::set_clk_0(char const *s)
{
...
void MOD_mkbarrel32tb::dump_state(unsigned int indent)
{
  printf("%*s%s:\n", indent, "", inst_name);
...
unsigned int MOD_mkbarrel32tb::dump_VCD_defs(unsigned int levels)
{
...
void MOD_mkbarrel32tb::dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkbarrel32tb &backing)
{
  vcd_defs(dt, backing);
  vcd_prims(dt, backing);
}

void MOD_mkbarrel32tb::vcd_defs(tVCDDumpType dt, MOD_mkbarrel32tb &backing)
{
  unsigned int num = vcd_num;
  if (dt == VCD_DUMP_XS)
  {
...
void MOD_mkbarrel32tb::vcd_prims(tVCDDumpType dt, MOD_mkbarrel32tb &backing)
{
